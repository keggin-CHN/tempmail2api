"""Disposablemail.com provider — Minuteinbox-style REST API."""
...
class DisposablemailClient(TempMailClient):
    """Client for https://www.disposablemail.com/"""

    BASE_URL = "https://www.disposablemail.com"

    @property
    def provider_name(self) -> str:
        return "disposablemail"
    ...
    def generate_email(self, duration_minutes: int = 10, domain: Optional[str] = None) -> TempEmail:
        ...
        return TempEmail(address=email_addr, provider="disposablemail")
    ...
    def get_email_detail(self, address: str, email_id: str) -> Optional[InboxEmail]:
        ...
        if resp.status_code == 200:
            ...
            return InboxEmail(id=email_id, provider="disposablemail", body_html=html)
        return None
