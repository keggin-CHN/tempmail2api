"""DisposableMail.com — same pattern as MinuteInbox (CSRF + AJAX JSON API)."""
...
class DisposablemailComClient(TempMailClient):
    ...
    def generate_email(self) -> TempEmail:
        ...
        return TempEmail(address=self._address, provider="disposablemail.com")
