"""10minemail.com — 10-minute disposable email using web2 API (JWT auth)."""
...
class TenminemailClient(TempMailClient):
    """Client for https://10minemail.com/ using web2 API (JWT auth)."""
    ...
    def generate_email(self) -> TempEmail:
        ...
        return TempEmail(address=self._address, provider="10minemail")
