...
class APIHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/api/health":
            ...
            json_response(self, 200, {
                ...
                "version": "2.5.0",
                "description": "9 个经实测验证的临时邮箱 provider",
    ...
    def _handle_openapi(self):
        spec = {
            ...
            "info": {
                ...
                "version": "2.5.0",
                "description": "9 个经实测验证的临时邮箱 provider (InboxKitten, Mailnesia, Anonymmail, TempMail.lol, ChatGPTMail, TempMail.ing, Guerrilla Mail, Maildrop, mail.tm)",
            },
            "paths": {
                "/api/health": {
    ...
    def _handle_providers(self):
        json_response(self, 200, {
            ...
            "verified": ["inboxkitten", "mailnesia", "tempmaillol", "chatgptmail", "tempmailing", "guerrillamail", "maildrop", "mailtm"],
        })
...
def main():
    ...
    logger.info("📋 Provider: inboxkitten, mailnesia, anonymmail, tempmaillol, chatgptmail, tempmail, guerrillamail, maildrop, mailtm")
    try:
